...
| Date       | EIG / Mentors | LLL      | Thématique                           | Objectifs                                                    | "After"                      |
|------------+---------------+----------+--------------------------------------+--------------------------------------------------------------+------------------------------|
...
|------------+---------------+----------+--------------------------------------+--------------------------------------------------------------+------------------------------|
| *14 juin*    | *EIG + mentors* | *Marylène* | *Bilan à mi-parcours*                  | *Faire un point EIG+mentors sur les feuilles de route*         | *Présentation de latitudes.cc* |
| 21 juin    | EIG seuls     |          | "Demo Day" (rue du Caire)            | Faire un point sur les projets et nous entraîner à présenter |                              |
| 12 juillet | Mentors seuls |          | Suite du bilan mentors à mi-parcours | Faire un point avec les mentors sur le reste de l'année      |                              |
| 30 août    | EIG seuls     |          |                                      |                                                              |                              |
| 13 sept    | EIG + mentors |          |                                      |                                                              |                              |
...
Nous présenter, en 5 minutes par défi, nos réalisations.
...
1. Ouverture : Laure Lucchesi, directrice d’Etalab (TBC)

2. Travail par défi sur le bilan, avec comme support les indicateurs
   de départ.

3. Mise en commun et réalisation d'un macro-calendrier.

4. Travail sur la pérennisation et les opportunités de développement
   des produits EIG.

5. Retours d'expériences sur le programme EIG.
