...
- [P] {Front app - Etablissement} Intégration des rattachements à d'autres établissement et des typologies
- [P] {Front app - Admin} Administration des tables de categories (liens, code, rattachement,...)
- [D] {Données ESR} Extraire une nomenclature pour essayer une première fois de la classification sur les papiers de recherches avec une nomenclature limitée
- [P] {Modèle} Test de ce modèle sur cette nomenclature
- [P] {API} Normaliser les erreur sur l’API
- [P] {API} vérifier le test coverage
- [P] commencer le micro service de récupération de data depuis le BCE
...
** Journal
   ...
   |--------------+------------+-------------------------------------------------------------------------------------------------------------------------+-------------------+-----+---|
   | Prévisecours | Opendata   | Automatisation des projets de récupération des données ouvertes                                                         | <2018-04-18 mer.> | P   | 1 |
   | Prévisecours | Opendata   | Nettoyage des projets de récupération des données ouvertes                                                              | <2018-04-18 mer.> | P   | 1 |
   | Prévisecours | Opendata   | Documentation des projets de récupération des données ouvertes                                                          | <2018-04-18 mer.> | P   | 1 |
   | Prévisecours | Prédiction | Farming de modèles                                                                                                      | <2018-04-18 mer.> | P   | 1 |
   | Prévisecours | AdminSys   | Réglages de l'instance de travail                                                                                       | <2018-04-18 mer.> | P   | 1 |
