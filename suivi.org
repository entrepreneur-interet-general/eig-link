...
- [T] Session EIG Documentation
- [P] Packaging des premiers livrables
- [C] Documentation des packages
- [T] Préparation de la session brainstorming “Le Shom et le Web”
- [P] Répartition des prochaines tâches pour le Javascript du Service Nautique Interactif
...
- [P] Finir de génerer les nouveaux dataset de pays
- [P] Matcher sous dataset de pays avec base annexe
...
- [P] Préparation des slides pour le copil
- [D] ETL pour préparer les données CROSS pour l'open data et pour nous
- [D] Réalisation de graphiques / dashboards statistiques
- [A] LLL + atelier ligne de commandes
...
** Journal
   ...
   |--------------+--------------+-------------------------------------------------------------------------------------------------------------------------+-------------------+-----+---|
   | Prévisecours | Prédiction   | Choix des features principales                                                                                          | <2018-05-07 lun.> | P   |   |
   | Prévisecours | Prédiction   | Nettoyage, documentation et automatisation des projets de prédiction des interventions                                  | <2018-05-07 lun.> | P   |   |
   | Prévisecours |              | Fork Cartav et montée en compétence dessus                                                                              | <2018-05-07 lun.> | A   |   |
   | Prévisecours |              | Écriture + Publication d’un package npm de conversion de GeoJson en lambert93 vers un geoJson en GPS                    | <2018-05-07 lun.> | P   |   |
   | Prévisecours |              | Publication d’un starter kit [vueJS + python FlaskRest] sur le repo EIG (mini-wetransfer)                               | <2018-05-07 lun.> | P   |   |
   | Prévisecours |              | Installation de plantes dans le bureau                                                                                  | <2018-05-07 lun.> | M   |   |
