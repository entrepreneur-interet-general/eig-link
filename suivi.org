...
** Journal
   ...
   |-------------+------------------------+-----------------------------------------------------------------------------+-------------------+-----|
   | Archifiltre |                        | Rencontre avec de potentiels utilisateurs de Stalactites pour diagnostic... | <2018-05-22 mar.> | U   |
   | Archifiltre |                        | Présentation de Stalactites au Ministère des Armées (c'était une conf su... | <2018-05-22 mar.> | C   |
...
- Participation à l'EIG Off sur le graphe
- Session de revue de code
- Avancer sur la cartographie des données
- Avancer sur les entrées de blog
