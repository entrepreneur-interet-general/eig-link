...
- [P] Focus sur le site v2
- [P] Écrire compte-rendu Garagethon par mail et pour blog
- [M] Session d’accompagnement du 11 avril
...
- [U] Rencontre de 2 chargés de mission pour l'étude de nos personas
- [AP] Wordflow owncloud
- [A] Evaluation de l'outil kanboard pour motoriser le workflow de signalements et visites d'entreprises et son intéraction avec un frontend.
- [U] Rencontre de 2 statisticiennes de l'Urssaf (Franche Comté et Bourgogne) pour continuer le travail de notre compréhension de leurs bases et de leur compréhension de nos calculs.
- [DP] Analyse en vue de stocker les résultats du feature engineering en mode versionning.
- [D] Intégration d'un nouveau fichier urssaf pour la liaison entre leurs comptes et nos sirets
- [P] Tentative de production d'un nouveau fichier de prédiction sur la base mongodb
